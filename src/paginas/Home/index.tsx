      ...
      >
        <Box alignContent="center">
          ...
          <Typography variant="h5" marginTop="10px" sx={{ color: 'black' }}>
            Através de nosso sistema conseguimos fazer uma análise de seus
            ativos, comparando com meses anteriores e ajudando a fazer a
            declaração de seu imposto de renda.
          </Typography>
        </Box>
